#undef DIMENSIONALDOORS_API
#undef DIMENSIONALDOORS_VTABLE
...
#define UE_PROJECT_NAME DimensionalDoors
...
#define TRACELOG_API 
#define DIMENSIONALDOORS_VTABLE 
#define DIMENSIONALDOORS_API 
